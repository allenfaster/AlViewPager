package com.allen.alpagerview.utils;
...
public class ResourceUtils {
    ...
    public static int getIdFromDrawable(Fragment fragment, String name) {
        int drawableId = fragment.getResources().getIdentifier(name, "drawable", fragment.getContext().getPackageName());
        return drawableId;
    }
